      ...
      <b-row>
        <b-col sm="4">
          <div class="movie-poster-wrap">
            <div class="movie-poster" :style="styleBgImage"></div>
          </div>
        </b-col>
        <b-col sm="8">
...
export default {
  ...
  data: () => ({
    defaultBackground: `linear-gradient(45deg, rgb(0, 3, 38) 0%, rgb(82, 15, 117) 100% )`,
  }),
  computed: {
    posterBg() {
      return this.movie ? `url(${this.movie.Poster})` : this.defaultBackground;
    },
    styleBgImage() {
...
.movie-rating :deep(.b-rating-icon) {
